...
class Room {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`title`,`image_name`,`short_description`,`description`,`no_of_rooms`,`price`,`facility`,`queue` FROM `room` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `room` (`title`,`image_name`,`short_description`,`description`,`no_of_rooms`,`price`,`facility`,`queue`) VALUES  ('"
                . $this->title . "','"
                . $this->image_name . "', '"
