...
$COUNT_PHOTO_ALBUM = count(PhotoAlbum::all());
?> 
<!DOCTYPE html>
<html> 
    <head>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card">
                            <div class="header bg-blue-grey">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <div class="number count-to" data-from="0" data-to=" <?php echo $COUNT_PHOTO_ALBUM; ?>" data-speed="1500" data-fresh-interval="1"></div>
                                </ul>
                            </div>
                            <div class="body">
